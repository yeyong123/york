# RailsAdmin config file. Generated on September 16, 2013 11:09
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['York', 'Admin']
  ...
  # config.excluded_models = ['Admin', 'Cart', 'Category', 'LineItem', 'List', 'Order', 'Photo', 'Product', 'ProductUser', 'Tag', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Admin', 'Cart', 'Category', 'LineItem', 'List', 'Order', 'Photo', 'Product', 'ProductUser', 'Tag', 'User']
  ...
  #     configure :line_items, :has_many_association 
  #     configure :product_users, :has_many_association 
  ...
  #     configure :use, :string 
  #     configure :load, :string 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :view_count, :integer 
  #     configure :liked_count, :integer 
  #     configure :list_id, :integer 
  ...
  # config.model 'ProductUser' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your product_user.rb model definition
